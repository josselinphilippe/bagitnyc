    ...
    for media in Instagram_API():
        try:
            ...
            if media.location:
                ...
                print media.images['standard_resolution'].url, media.user.username, media.id, media.location.point.latitude, media.location.point.longitude, media.created_time
